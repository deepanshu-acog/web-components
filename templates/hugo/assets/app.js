// Set Web Awesome base path
import { setBasePath } from "@awesome.me/webawesome";
setBasePath("/webawesome/");

// Every Web Awesome component, imported explicitly. Not incremental — the
// autoloader (webawesome.loader.js) cannot self-locate its assets once
// bundled by esbuild, so any tag used in content that isn't imported here
// silently 404s. Importing the whole catalog once means content authors
// never touch this file again to use a new wa-* component.
...
// Aganitha UI components
import "@aganitha/atk-ui/components/molstar";
import "@aganitha/atk-ui/components/metric";
import "@aganitha/atk-ui/components/sidenote";
import "@aganitha/atk-ui/components/timeline";
import "@aganitha/atk-ui/components/timeline-item";
import "@aganitha/atk-ui/components/mermaid";
import "@aganitha/atk-ui/components/data-table";
import "@aganitha/atk-ui/components/go-ribbon";
import "@aganitha/atk-ui/components/well-plate";
import "@aganitha/atk-ui/components/chart";
